...
**Testes Negativos**
- **Usuário Sem Dados (POST)** : testa resposta da API quando o body está vazio.  
- **Buscar Usuário Inexistente (GET)** : verifica comportamento ao buscar ID inexistente.  
- **Atualizar Dados Inválidos (PUT)** : testa se a API rejeita dados incorretos (em JSONPlaceholder, aceita qualquer dado).
